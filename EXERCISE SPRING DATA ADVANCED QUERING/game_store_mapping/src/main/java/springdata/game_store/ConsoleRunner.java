...
import springdata.game_store.controllers.GameController;
import springdata.game_store.controllers.UserController;
import springdata.game_store.domain.services.GameServiceImpl;
import springdata.game_store.domain.services.UserServiceImpl;
...
import springdata.game_store.repository.UserRepository;
...
public class ConsoleRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        while (true) {
            ...
            String pathName = "games_tore.controllers." + controllerName + "Controller";
